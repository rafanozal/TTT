...
source("tttV9.R",        encoding="utf-8")
source("hypothesisV9.R", encoding="utf-8")

# These inputs are for each of the sizers test

#kernel  = "epanechnikov" # Which kernel do you want
kernel  = "gaussian"     # Which kernel do you want
#kernel  = "triweight"    # Which kernel do you want
...
repetitions   = 1                        # How many times do you want to repeat the tests (M=1000 probably, page 24 Table1.)
