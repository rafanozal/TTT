...
#'                time to calculate.
#' 
#' @param ygrid   how many h we are going to generate. 
#' 
#'                Default is 11.
#' 
...
#' 
#'                "bootstrap" (DEFAULT)
#'                    - Does a bootstrap of 100 iteration over the data 
#'                    
#'                "moments"
#'                    - Calculate the variance using classical central moments.
#'                      When the number of samples is big the factorial number 
#'                      does whacky things and you can get weird results
#'                      
#'                "beta"
